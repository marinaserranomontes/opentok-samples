package com.opentok.android.sample.video;
...
public class CustomVideoRenderer extends BaseVideoRenderer {
    private static final String LOGTAG = "opentok-sample-renderer";
    Context mContext;
    ...
    static class MyRenderer implements GLSurfaceView.Renderer {
        ...
        static void initializeTexture(int name, int id, int width, int height) {
            Log.d("nitro", "initialize texture:" + width + "," + height);
        ...
        void setupTextures(Frame frame) {
            ...
            initializeTexture(GLES20.GL_TEXTURE1, mTextureIds[1], uv_w, uv_h);
            initializeTexture(GLES20.GL_TEXTURE2, mTextureIds[2], uv_w, uv_h);
        ...
        void updateTextures(Frame frame) {
            ...
            int quarterPlaneSize = uv_w*uv_h;
            ...
            if (bb.remaining() == planeSize + quarterPlaneSize * 2) {
                bb.position(0);
                ...
                GLES20.glPixelStorei(GLES20.GL_UNPACK_ALIGNMENT, width);
                GLES20.glTexSubImage2D(GLES20.GL_TEXTURE_2D, 0, 0, 0, width,
                        height, GLES20.GL_LUMINANCE, GLES20.GL_UNSIGNED_BYTE,
                        bb);

                bb.position(planeSize);
                GLES20.glActiveTexture(GLES20.GL_TEXTURE1);
                GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, mTextureIds[1]);
                GLES20.glTexSubImage2D(GLES20.GL_TEXTURE_2D, 0, 0, 0,
                        uv_w, uv_h, GLES20.GL_LUMINANCE,
                        GLES20.GL_UNSIGNED_BYTE, bb);

                bb.position(planeSize + quarterPlaneSize);
        ...
        public void onDrawFrame(GL10 gl) {
            ...
            if (mCurrentFrame != null && !mVideoDisabled) {
                Log.d(LOGTAG, "Renderer frame size: "+mCurrentFrame.getWidth()+"x"+mCurrentFrame.getHeight());
